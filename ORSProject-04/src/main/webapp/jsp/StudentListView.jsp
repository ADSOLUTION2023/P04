			...
			<form action="<%=ORSView.STUDENT_LIST_CTL%>" method="post">
				...
				<table border="1" style="width: 100%; border: groove;">
					...
					<tr>
						...
						<input type="checkbox" class="case" name="ids" value="<%=bean.getId()%>"></td>
						...
						<td style="text-align: center; text-transform: capitalize;"><%=bean.getCollegeId()%></td>
						...
						<td style="text-align: center;">
						<a href="<%=ORSView.STUDENT_CTL%>?id=<%=bean.getId()%>">Edit</a></td>
					</tr>
					<%
						}
					%>
				...
				<table style="width: 100%">
					<tr>
						...
						<td align="center" style="width: 25%"><input type="submit" name="operation" value="<%=StudentListCtl.OP_NEW%>"></td>
						<td align="center" style="width: 25%"><input type="submit" name="operation" value="<%=StudentListCtl.OP_DELETE%>"></td>
						
						<td style="width: 25%" align="right"><input type="submit" name="operation" value="<%=StudentListCtl.OP_NEXT%>"
