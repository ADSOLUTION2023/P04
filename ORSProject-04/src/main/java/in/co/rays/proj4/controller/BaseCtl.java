...
/**
 * BaseCtl is an abstract controller class and parent of all controllers that
 * provides common functionalities for all controllers in the application. It
 * manages operations, validation, DTO population and common request handling
 * logic.
 *
 * <p>
...
public abstract class BaseCtl extends HttpServlet {
	...
	/**
	 * Validates request input. Subclasses can override this method to provide their
	...
	/**
	 * Used to preload data required for the view (such as dropdownlists).
	...
	/**
	 * Populates common audit fields (createdBy, modifiedBy, timestamps) for the
	 * DTO.
	 *
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		if (DataValidator.isNotNull(op) && !OP_CANCEL.equalsIgnoreCase(op) && !OP_VIEW.equalsIgnoreCase(op)
			...
			if (!validate(request)) {
				System.out.println("Operation IN VALIDATE : " + op);
	...
	/**
	 * Abstract method to return the JSP page associated with the controller. Each
