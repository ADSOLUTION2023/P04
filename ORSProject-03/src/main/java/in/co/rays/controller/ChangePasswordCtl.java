...
public class ChangePasswordCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (in.co.rays.util.DataValidator.isNull(request.getParameter("confirmpassword"))) {
			request.setAttribute("confirmpassword", in.co.rays.util.PropertyReader.getValue("error.require", "Confirm Password"));
			pass = false;
		}
		if (!request.getParameter("newpassword").equals(request.getParameter("confirmpassword"))
				&& !"".equals(request.getParameter("confirmpassword"))) {
			in.co.rays.util.ServletUtility.setErrorMessage("New and confirm passwords not matched", request);
			pass = false;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		in.co.rays.util.ServletUtility.forward(getView(), request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String op = in.co.rays.util.DataUtility.getString(request.getParameter("operation"));
		in.co.rays.model.UserModelInt model = ModelFactory.getInstance().getUserModel();
